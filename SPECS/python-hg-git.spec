...
Source0:	https://bitbucket.org/durin42/hg-git/get/0.3.4.tar.bz2
...
%prep
%setup -q -n durin42-hg-git-586b7aa96466

# Disable test-encoding:
sed -i -e '2s/^.*$/exit 80/' tests/test-encoding
